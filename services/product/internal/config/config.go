...
type LoggerConfig struct {
	...
	OutputFilePath      string   `env:"LOG_OUTPUT_FILE" env-default:"logs/product.log"`
	ErrorOutputFilePath string   `env:"LOG_ERROR_OUTPUT_FILE" env-default:"logs/product_error.log"`
}
