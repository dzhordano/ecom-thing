...
func (m *MockProductService) SearchProducts(ctx context.Context, filters map[string]any, limit, offset uint64) ([]*domain.Product, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SearchProducts", ctx, filters, limit, offset)
	ret0, _ := ret[0].([]*domain.Product)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockProductServiceMockRecorder) SearchProducts(ctx, filters, limit, offset interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SearchProducts", reflect.TypeOf((*MockProductService)(nil).SearchProducts), ctx, filters, limit, offset)
}
